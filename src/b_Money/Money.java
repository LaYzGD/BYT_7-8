...
public class Money implements Comparable {
	...
	public String toString() {
		return String.format("%d.%d %s", amount/100, amount%100, currency.getName());
	}
